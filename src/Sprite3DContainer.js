 ...
 * @constructor
 */
function Sprite3DContainer(texture)
{
...
Sprite3DContainer.prototype = Object.create(PIXI.Sprite.prototype);
Sprite3DContainer.prototype.constructor = Sprite3DContainer;

/**
 * @private
 */
Sprite3DContainer.prototype._renderWebGL = function(renderer)
{
 ...
 * @protected
 */
Sprite3DContainer.prototype.updateTransform = function()
{
    if (!this.visible)
        return;
